...
class APIfeature {
    ...
    filtering() {
        ...
        const excludeFields = ['page', 'soft', 'limit']
        ...
        //lt = less than= <
        //gt = great than= >
        //regex = regular expressions, tìm từ có chứa trong ""
        this.query.find(JSON.parse(queryStr)) // lọc và chuyển dữ liệu từ dạng json về dạng js
